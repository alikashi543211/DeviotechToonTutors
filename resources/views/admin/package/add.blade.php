...
<div class="container-fluid">
    <form method="post" action="{{route('admin.packages.save')}}" class="cmxform" id="registration-form">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="hours" name="hours" class="form-control @error('hours') is-invalid @enderror">
                            @error('hours')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="per_hour_amount" name="per_hour_amount" class="form-control @error('per_hour_amount') is-invalid @enderror">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="total_amount" name="total_amount" class="form-control @error('total_amount') is-invalid @enderror" readonly>
                            @error('total_amount')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
