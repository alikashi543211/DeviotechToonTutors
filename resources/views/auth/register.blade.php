        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="apply-now-from">
                    <h2 class="text-center mb-4">Register <span style="color: #f26d64;">Here.</span></h2>
                        ...
                        <div class="tab-pane fade show active" id="student" role="tabpanel" aria-labelledby="student-tab">
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" size="191" id="name" class="form-control @error('name') is-invalid @enderror">
                                    @if (session('student'))
                                        @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" size="191" id="student_name" class="form-control @error('email') is-invalid @enderror">
                                    @if (session('student'))
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" size="191" id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror">
                                    @if (session('student'))
                                ...
                                <div class="form-group position-relative">
                                    ...
                                    <input type="text" name="dob" size="191" id="dob" class="student_dob form-control datepicker @error('dob') is-invalid @enderror" autocomplete="off">
                                    @if (session('student'))
                                        @error('dob')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="time_zone" class="form-control select2 @error('time_zone') is-invalid @enderror">
                                ...
                                <div class="form-group text-center">
                                    <button type="submit" class="btn btn-default btn-square text-center student_register">Register</button>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="parent" role="tabpanel" aria-labelledby="parent-tab">
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" size="191" id="phone" class="form-control @error('phone') is-invalid @enderror">
                                    @if (session('parent'))
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    <label for="password_confirmation">Confirm Password:</label>
                                    <input type="password" name="password_confirmation" size="191" id="password_confirmation" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="time_zone">Time Zone:</label>
                                    <select name="time_zone" class="form-control select2 @error('time_zone') is-invalid @enderror">
                                ...
                                <div class="card mb-2" style="background-color:#f9f9f9">
                                    <div class="card-body">
                                        <div class="form-group position-relative">
                                            <label for="student_name">Student Name:</label>
                                            <input type="text" name="student_name[]" size="191" id="student_name" class="form-control" autocomplete="off" required>
                                        </div>
                                        <div class="form-group position-relative">
                                            <label for="student_dob">Student DOB:</label>
                                            <input type="text" name="student_dob[]" size="191" id="student_dob" class="form-control datepicker" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="append-student">

                                </div>
                                <div class="form-group text-right">
                                    <button type="button" class="btn btn-default btn-small add-student">+ Add</button>
                                </div>
                                <div class="form-group text-center">
                                    <p>Already Have Account <a href="{{ route('login') }}">Login Here</a></p>
                                </div>
                                <div class="form-group text-center">
                                    <button type="submit" class="btn btn-default btn-square text-center">Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('js')
    <script>
        $(document).ready(function () {
            var html = '<div class="card mb-2" style="background-color:#f9f9f9">'+
                            '<div class="card-body">'+
                            '    <div class="form-group text-right"><button type="button" class="btn btn-danger btn-sm delete-student"><i class="fa fa-times"></i></button></div>'+
                            '    <div class="form-group position-relative">'+
                            '        <label for="student_name">Student Name:</label>'+
                            '        <input type="text" name="student_name[]" size="191" id="student_name" class="form-control" autocomplete="off" required>'+
                            '    </div>'+
            ...
            $('.student_dob').on('dp.change', function(e){
                ...
                if (age < 16) {
                    ...
                    $elm.closest('.form-group').find('.error strong').html('You are not allowed to register, Please ask your parents to do so!');
    ...
    @if (session('student'))
        <script>
            $(".apply-now-from .nav-item .nav-link").removeClass('active');
