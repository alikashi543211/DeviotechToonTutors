...
<section class="edit-profile-section">
    <form action="{{ route('student.edit.profile.save') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden; position: relative;">
                        @if (auth()->user()->student_profile->profile_photo != "")
                            <img src="{{ asset(auth()->user()->student_profile->profile_photo) }}" id="disimg" height="100%" style="width: 100%;; object-fit: cover; object-position: center;">
                        @else
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ auth()->user()->student_profile->phone }}" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
