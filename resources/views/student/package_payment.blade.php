    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <p class="font-weight-bold text-center">You are purchasing "{{ $package->name }}" Package for ${{ $package->total_amount }}</p>
                        <form action="{{ route('student.purchase') }}" method="POST" id="payment-form" class=" text-center">
                            @csrf
