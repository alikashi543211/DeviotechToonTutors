                                        ...
                                        <table class="table table-custom">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ studentDate($data->active_date, $data->slot) }}</td>
                                                    <td>{{ studentSlot($data->slot) }}</td>
                                                    <td>
                                                        @if($data->interval == 1)
                                                            One Time
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <a href="{{ route('student.recurring.payment', $data->id) }}"><span class="badge badge-danger">Not Paid</span> <br>Click to Pay</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
...
@section('js')
    ...
    <script>
        ...
        $(document).on("click", ".sure-cancel", function(){
            window.location.href = "{{ route('student.request.tutor.status') }}/cancel/"+$(this).attr('data-id');
        });
    </script>
@endsection
