        ...
        <div class="row">
            ...
            @else
                <div class="col-12 text-center pt-4 pb-4">
                    ...
                    <p>Looks like you haven't initiated a conversation <br> with any of tutor</p>
                </div>
            @endif
        </div>
    </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('.conversation .search input').on('keyup', function(){
                    var q = $(this).val();
                    $.get("{{ route('parent.contacts') }}?q="+q,function(contacts){
            ...
            var reloadConversation = function(){
                $.get("{{ route('parent.get.chat') }}?id="+convo_id, function(messages){
            ...
            $("form.msger-inputarea").submit(function(e) {
                ...
                if(chat_content.val().trim().length <= 0) {
                    ...
                    $.ajax({
                        url: '{{ route("parent.save.messsage") }}',
                        data: {
