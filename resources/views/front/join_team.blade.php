...
@endsection
@section('content')
{{-- <section class="page-hero-section" style="background-image: url({{ asset('theme/images/photo-40.jpg') }});">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-md-right text-center mb-4">
                <img src="{{ asset('theme/images/joint-team-area.png') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-6 m-auto mb-4">
                <div class="media">
                    <div class="media-left mr-3 pt-1">
                        <i class="fa fa-graduation-cap"></i>
                    </div>
                    <div class="media-left">
                        <p><strong>Become a Toon Tutor.</strong> We are always looking to add talented tutors to our
                                    team who can help spread the joy of learning.
                        </p>
                    </div>
                </div>
                <div class="benefits-joining mt-4">
                    <h2 class="benefits">Benefits of <span style="color: #f26d64;">Joining Us</span></h2>
                    <div class="mt-5"></div>
                    <ol class="gradient-list">
                        <li>Be part of a growing community of driven, talented, and like-minded individuals.</li>
                        <li>Great opportunity for building your resume and references.</li>
                        <li>Flexible work schedule that can easily be accommodated with full-time school.</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section class="apply-now-section" id="join_team_section" style="background-image: url({{ asset('theme/images/feather-long-bg.jpg') }});">
    <div class="container">
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <div class="apply-now-from">
                    <h2 class="text-center mb-4">Apply Now to be a <span style="color: #f26d64;">Tutor!</span></h2>
                    <form action="{{ route('tutor.register') }}" method="POST" enctype="multipart/form-data" class="validate-form">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="file" name="profile_photo" id="profile_photo" data-height="200" class="dropify">
                        </div>
                        <div class="form-group">
                            <label for="name">Name:</label>
                            <input type="text" name="name" size="191" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" size="191" id="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror">
                            <span class="invalid-feedback" role="alert">
                                <strong>
                                    @error('email')
                                        {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" size="191" value="{{ old('phone') }}" id="phone" class="form-control">
                            <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="video_url" size="191" value="{{ old('video_url') }}" id="video_url" class="form-control">
                            <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="dob" size="191" id="dob" value="{{ old('dob') }}" class="tutor-dob form-control datepicker" autocomplete="off">
                            <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span>
                            <span class="error">
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" id="" class="form-control" style="height: 43px; border-radius: 0px;">
                        ...
                        <div class="form-group" style="display: none;">
                            <label for="hourly_rate">Hourly Rate:
                                <small class="info-icon"
                                data-toggle="tooltip" data-placement="top"
                                title="Lorem Ipsum is simply dummy text of the printing and typesetting industry.">
                                    <i class="fa fa-info-circle"></i>
                            ...
                            <input type="text" name="hourly_rate" size="191" value="{{ old('hourly_rate') }}" id="hourly_rate" class="form-control">
                            <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" size="191" id="subject" value="{{ old('subject') }}" class="form-control" autocomplete="off">
                            <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span>
                        </div>
                        ...
                        <div class="form-group mt-5 mb-4">
                            <label for="currently_enrolled">
                                ...
                                I'm currently enrolled in full time studies with a high school or university.
                            </label>
                        </div>
                        <button type="submit" class="btn btn-default btn-square btn-tutor-submit">Submit</button>
                    </form>
                </div>
            </div>
            <div class="col-md-3"></div>
...
@section('js')
    @if($errors->any())
        <script>
            $('html, body').animate({
                scrollTop: $("#join_team_section").offset().top
            }, 2000);
        </script>
    @endif
    <script>
        $(".validate-form").validate({
            ...
            messages: {
                ...
                subject: {
                    required: 'Enter your subjects',
                },
                hourly_rate: {
                    required: 'Enter your Hourly Rate',
                },
                cover_letter: {
                    required: 'Upload your cover letter',
                },
                resume: {
