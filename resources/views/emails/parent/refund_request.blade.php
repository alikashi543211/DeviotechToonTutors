...
<tr>
    <td align="left" valign="top" style="border-collapse: collapse;font-size: 20px; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
    padding-top: 5px;
    color: #FFFFFF;
    font-family: sans-serif; justify-content: center;" class="paragraph">

    <div style="">
       <h4> Zoom Id: {{$data['zoom_id']}}</h4>
    </div>
</td>
</tr>
</table>
