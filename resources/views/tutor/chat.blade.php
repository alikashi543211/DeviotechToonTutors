...
<section class="tutor-dashboard-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Chat</h2>
                <h6>Here you can chat with your students</h6>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="contacts">
                                ...
                                <ul>
                                    ...
                                    <li class="contact" data-convo_id="{{ $item->id }}">
                                        <div class="wrap">
                                            <img src="{{ asset($item->student_user->student_profile->profile_photo) }}" alt="" />
                                            <div class="meta">
                                ...
                                <div class="clearfix">
                                    <div class="float-left">
                                        <div class="msger-header-title">
                                            <img src="{{ asset($converstaions[0]->student_user->student_profile->profile_photo ?? 'default.png') }}" width="40px" style="border-radius: 100%;" alt="">
                                            <h5 class="d-inline m-0">{{ $converstaions[0]->student_user->name }}</h5>
                                        </div>
                                    </div>
